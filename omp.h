...
#       endif
    {
      ...
      KMP_ALLOCATOR_MAX_HANDLE = SIZE_MAX
...
#       endif
    {
      ...
      KMP_MEMSPACE_MAX_HANDLE = SIZE_MAX
...
#   else
    typedef enum omp_event_handle_t { KMP_EVENT_MAX_HANDLE = SIZE_MAX } omp_event_handle_t;
#   endif
