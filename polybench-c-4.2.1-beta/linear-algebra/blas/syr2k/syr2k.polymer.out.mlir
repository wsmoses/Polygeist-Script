...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @main(%arg0: i32, %arg1: !llvm.ptr<ptr<i8>>) -> i32 {
    ...
    %8 = memref.cast %3 : memref<2600x2000xf64> to memref<?x2000xf64>
    %9 = memref.cast %4 : memref<2600x2000xf64> to memref<?x2000xf64>
    call @init_array(%c2600_i32, %c2000_i32, %5, %6, %7, %8, %9) : (i32, i32, memref<?xf64>, memref<?xf64>, memref<?x2600xf64>, memref<?x2000xf64>, memref<?x2000xf64>) -> ()
    call @polybench_timer_start() : () -> ()
    %10 = affine.load %0[0] : memref<1xf64>
    %11 = affine.load %1[0] : memref<1xf64>
    call @kernel_syr2k_opt(%c2600_i32, %c2000_i32, %10, %11, %7, %8, %9) : (i32, i32, f64, f64, memref<?x2600xf64>, memref<?x2000xf64>, memref<?x2000xf64>) -> ()
  ...
  func private @init_array(%arg0: i32, %arg1: i32, %arg2: memref<?xf64>, %arg3: memref<?xf64>, %arg4: memref<?x2600xf64>, %arg5: memref<?x2000xf64>, %arg6: memref<?x2000xf64>) {
    ...
    ^bb0(%arg7: i32, %arg8: i32):  // no predecessors
      ...
      ^bb0(%arg9: i32):  // no predecessors
        ...
        %16 = divf %14, %15 : f64
        memref.store %16, %arg6[%2, %5] : memref<?x2000xf64>
        %17 = addi %arg9, %c1_i32 : i32
        scf.yield %17 : i32
      }
  ...
  func private @kernel_syr2k(%arg0: i32, %arg1: i32, %arg2: f64, %arg3: f64, %arg4: memref<?x2600xf64>, %arg5: memref<?x2000xf64>, %arg6: memref<?x2000xf64>) {
    %0 = index_cast %arg0 : i32 to index
    %1 = index_cast %arg1 : i32 to index
    affine.for %arg7 = 0 to %0 {
      affine.for %arg8 = 0 to #map0(%arg7) {
        call @S0(%arg4, %arg7, %arg8, %arg3) : (memref<?x2600xf64>, index, index, f64) -> ()
      }
      affine.for %arg8 = 0 to %1 {
        affine.for %arg9 = 0 to #map0(%arg7) {
          call @S1(%arg4, %arg7, %arg9, %arg5, %arg8, %arg2, %arg6) : (memref<?x2600xf64>, index, index, memref<?x2000xf64>, index, f64, memref<?x2000xf64>) -> ()
        }
      }
    }
    return
  ...
  func private @kernel_syr2k_opt(%arg0: i32, %arg1: i32, %arg2: f64, %arg3: f64, %arg4: memref<?x2600xf64>, %arg5: memref<?x2000xf64>, %arg6: memref<?x2000xf64>) {
    %0 = index_cast %arg0 : i32 to index
    %1 = index_cast %arg1 : i32 to index
    affine.if #set()[%0, %1] {
        ...
        affine.for %arg8 = 0 to #map0(%arg7) {
          affine.for %arg9 = #map2(%arg7) to min #map3(%arg7)[%0] {
            affine.for %arg10 = #map2(%arg8) to min #map4(%arg9, %arg8) {
              call @S0(%arg4, %arg9, %arg10, %arg3) : (memref<?x2600xf64>, index, index, f64) -> ()
            }
          }
        }
      }
            ...
            affine.for %arg10 = #map2(%arg7) to min #map3(%arg7)[%0] {
              affine.for %arg11 = #map2(%arg8) to min #map4(%arg10, %arg8) {
                affine.for %arg12 = #map2(%arg9) to min #map3(%arg9)[%1] {
                  call @S1(%arg4, %arg10, %arg11, %arg5, %arg12, %arg2, %arg6) : (memref<?x2600xf64>, index, index, memref<?x2000xf64>, index, f64, memref<?x2000xf64>) -> ()
                }
              }
            }
          }
