...
entry:
  ...
  %10 = load [2600 x [2600 x double]]*, [2600 x [2600 x double]]** %C, align 8, !tbaa !6
  %arraydecay = getelementptr inbounds [2600 x [2600 x double]], [2600 x [2600 x double]]* %10, i64 0, i64 0
  %11 = load [2600 x [2000 x double]]*, [2600 x [2000 x double]]** %A, align 8, !tbaa !6
  %arraydecay2 = getelementptr inbounds [2600 x [2000 x double]], [2600 x [2000 x double]]* %11, i64 0, i64 0
  call void @init_array(i32 %8, i32 %9, double* %alpha, double* %beta, [2600 x double]* %arraydecay, [2000 x double]* %arraydecay2)
  call void (...) @polybench_timer_start()
  %12 = load i32, i32* %n, align 4, !tbaa !2
  %13 = load i32, i32* %m, align 4, !tbaa !2
  %14 = load double, double* %alpha, align 8, !tbaa !8
  %15 = load double, double* %beta, align 8, !tbaa !8
  %16 = load [2600 x [2600 x double]]*, [2600 x [2600 x double]]** %C, align 8, !tbaa !6
  %arraydecay3 = getelementptr inbounds [2600 x [2600 x double]], [2600 x [2600 x double]]* %16, i64 0, i64 0
  %17 = load [2600 x [2000 x double]]*, [2600 x [2000 x double]]** %A, align 8, !tbaa !6
  %arraydecay4 = getelementptr inbounds [2600 x [2000 x double]], [2600 x [2000 x double]]* %17, i64 0, i64 0
  call void @kernel_syrk(i32 %12, i32 %13, double %14, double %15, [2600 x double]* %arraydecay3, [2000 x double]* %arraydecay4)
...
land.lhs.true:                                    ; preds = %entry
  ...
  %call5 = call i32 @strcmp(i8* %20, i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.str, i64 0, i64 0)) #7
  %tobool = icmp ne i32 %call5, 0
  br i1 %tobool, label %if.end, label %if.then

if.then:                                          ; preds = %land.lhs.true
  %21 = load i32, i32* %n, align 4, !tbaa !2
  %22 = load [2600 x [2600 x double]]*, [2600 x [2600 x double]]** %C, align 8, !tbaa !6
  %arraydecay6 = getelementptr inbounds [2600 x [2600 x double]], [2600 x [2600 x double]]* %22, i64 0, i64 0
  call void @print_array(i32 %21, [2600 x double]* %arraydecay6)
  br label %if.end

if.end:                                           ; preds = %if.then, %land.lhs.true, %entry
  %23 = load [2600 x [2600 x double]]*, [2600 x [2600 x double]]** %C, align 8, !tbaa !6
  %24 = bitcast [2600 x [2600 x double]]* %23 to i8*
  call void @free(i8* %24) #6
  %25 = load [2600 x [2000 x double]]*, [2600 x [2000 x double]]** %A, align 8, !tbaa !6
  %26 = bitcast [2600 x [2000 x double]]* %25 to i8*
  call void @free(i8* %26) #6
  %27 = bitcast [2600 x [2000 x double]]** %A to i8*
  call void @llvm.lifetime.end.p0i8(i64 8, i8* %27) #6
  %28 = bitcast [2600 x [2600 x double]]** %C to i8*
...
for.body17:                                       ; preds = %for.cond14
  ...
  %25 = load [2600 x double]*, [2600 x double]** %C.addr, align 8, !tbaa !6
...
for.body11:                                       ; preds = %for.cond9
  ...
  %18 = load [2000 x double]*, [2000 x double]** %A.addr, align 8, !tbaa !6
  %19 = load i32, i32* %i, align 4, !tbaa !2
  %idxprom12 = sext i32 %19 to i64
  %arrayidx13 = getelementptr inbounds [2000 x double], [2000 x double]* %18, i64 %idxprom12
  ...
  %22 = load [2000 x double]*, [2000 x double]** %A.addr, align 8, !tbaa !6
  ...
  %26 = load [2600 x double]*, [2600 x double]** %C.addr, align 8, !tbaa !6
  %27 = load i32, i32* %i, align 4, !tbaa !2
  %idxprom22 = sext i32 %27 to i64
  %arrayidx23 = getelementptr inbounds [2600 x double], [2600 x double]* %26, i64 %idxprom22
  %28 = load i32, i32* %j, align 4, !tbaa !2
