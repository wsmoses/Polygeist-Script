...
#set = affine_set<()[s0, s1] : (s0 - 2 >= 0, s1 - 1 >= 0)>
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @main(%arg0: i32, %arg1: !llvm.ptr<ptr<i8>>) -> i32 {
    ...
    %7 = memref.cast %2 : memref<2000x2600xf64> to memref<?x2600xf64>
    %8 = memref.cast %3 : memref<2000x2000xf64> to memref<?x2000xf64>
    %9 = memref.cast %4 : memref<2000x2600xf64> to memref<?x2600xf64>
    call @init_array(%c2000_i32, %c2600_i32, %5, %6, %7, %8, %9) : (i32, i32, memref<?xf64>, memref<?xf64>, memref<?x2600xf64>, memref<?x2000xf64>, memref<?x2600xf64>) -> ()
    call @polybench_timer_start() : () -> ()
    %10 = affine.load %0[0] : memref<1xf64>
    %11 = affine.load %1[0] : memref<1xf64>
    call @kernel_symm_opt(%c2000_i32, %c2600_i32, %10, %11, %7, %8, %9) : (i32, i32, f64, f64, memref<?x2600xf64>, memref<?x2000xf64>, memref<?x2600xf64>) -> ()
    ...
    scf.if %13 {
      call @print_array(%c2000_i32, %c2600_i32, %7) : (i32, i32, memref<?x2600xf64>) -> ()
    }
  ...
  func private @init_array(%arg0: i32, %arg1: i32, %arg2: memref<?xf64>, %arg3: memref<?xf64>, %arg4: memref<?x2600xf64>, %arg5: memref<?x2000xf64>, %arg6: memref<?x2600xf64>) {
    ...
    %0:2 = scf.while (%arg7 = %c0_i32) : (i32) -> (i32, i32) {
      %2 = cmpi slt, %arg7, %arg0 : i32
      scf.condition(%2) %c0_i32, %arg7 : i32, i32
    } do {
    ^bb0(%arg7: i32, %arg8: i32):  // no predecessors
      %2 = index_cast %arg8 : i32 to index
      ...
      ^bb0(%arg9: i32):  // no predecessors
        ...
        %6 = addi %arg8, %arg9 : i32
        %7 = remi_signed %6, %c100_i32 : i32
        %8 = sitofp %7 : i32 to f64
        %9 = sitofp %arg0 : i32 to f64
        %10 = divf %8, %9 : f64
        memref.store %10, %arg4[%2, %5] : memref<?x2600xf64>
        %11 = addi %arg1, %arg8 : i32
        %12 = subi %11, %arg9 : i32
        %13 = remi_signed %12, %c100_i32 : i32
        %14 = sitofp %13 : i32 to f64
        %15 = divf %14, %9 : f64
        memref.store %15, %arg6[%2, %5] : memref<?x2600xf64>
        %16 = addi %arg9, %c1_i32 : i32
        scf.yield %16 : i32
      }
      %4 = addi %arg8, %c1_i32 : i32
      scf.yield %4 : i32
    }
    %1 = scf.while (%arg7 = %0#0) : (i32) -> i32 {
      %2 = cmpi slt, %arg7, %arg0 : i32
      scf.condition(%2) %arg7 : i32
    } do {
    ^bb0(%arg7: i32):  // no predecessors
      %2 = index_cast %arg7 : i32 to index
      %3 = scf.while (%arg8 = %c0_i32) : (i32) -> i32 {
        %8 = cmpi sle, %arg8, %arg7 : i32
        scf.condition(%8) %arg8 : i32
      } do {
      ^bb0(%arg8: i32):  // no predecessors
        %8 = index_cast %arg8 : i32 to index
        %9 = addi %arg7, %arg8 : i32
        %10 = remi_signed %9, %c100_i32 : i32
        %11 = sitofp %10 : i32 to f64
        %12 = sitofp %arg0 : i32 to f64
        %13 = divf %11, %12 : f64
        memref.store %13, %arg5[%2, %8] : memref<?x2000xf64>
        %14 = addi %arg8, %c1_i32 : i32
        scf.yield %14 : i32
      }
      %4 = addi %arg7, %c1_i32 : i32
      %5 = index_cast %arg0 : i32 to index
      %6 = addi %2, %c1 : index
      %7 = scf.for %arg8 = %6 to %5 step %c1 iter_args(%arg9 = %4) -> (i32) {
        %8 = index_cast %arg9 : i32 to index
        %9 = sitofp %c-999_i32 : i32 to f64
        memref.store %9, %arg5[%2, %8] : memref<?x2000xf64>
        %10 = addi %arg9, %c1_i32 : i32
        scf.yield %10 : i32
      }
      scf.yield %4 : i32
    }
  ...
  func private @kernel_symm(%arg0: i32, %arg1: i32, %arg2: f64, %arg3: f64, %arg4: memref<?x2600xf64>, %arg5: memref<?x2000xf64>, %arg6: memref<?x2600xf64>) {
    ...
    affine.for %arg7 = 0 to %2 {
      affine.for %arg8 = 0 to %0 {
        ...
        affine.for %arg9 = 0 to #map(%arg7) {
          call @S1(%arg4, %arg9, %arg8, %arg5, %arg7, %arg2, %arg6) : (memref<?x2600xf64>, index, index, memref<?x2000xf64>, index, f64, memref<?x2600xf64>) -> ()
          call @S2(%1, %arg5, %arg7, %arg9, %arg6, %arg8) : (memref<1xf64>, memref<?x2000xf64>, index, index, memref<?x2600xf64>, index) -> ()
        }
        call @S3(%arg4, %arg7, %arg8, %arg2, %1, %arg5, %arg6, %arg3) : (memref<?x2600xf64>, index, index, f64, memref<1xf64>, memref<?x2000xf64>, memref<?x2600xf64>, f64) -> ()
      }
    }
    return
  }
  ...
  func private @kernel_symm_opt(%arg0: i32, %arg1: i32, %arg2: f64, %arg3: f64, %arg4: memref<?x2600xf64>, %arg5: memref<?x2000xf64>, %arg6: memref<?x2600xf64>) {
    %c0 = constant 0 : index
    %0 = memref.alloca() : memref<1xf64>
    ...
    affine.if #set()[%1, %2] {
      affine.for %arg7 = 0 to %2 {
        ...
        call @S3(%arg4, %c0, %arg7, %arg2, %0, %arg5, %arg6, %arg3) : (memref<?x2600xf64>, index, index, f64, memref<1xf64>, memref<?x2000xf64>, memref<?x2600xf64>, f64) -> ()
      }
      affine.for %arg7 = 1 to %1 {
        affine.for %arg8 = 0 to %2 {
          call @S1(%arg4, %c0, %arg8, %arg5, %arg7, %arg2, %arg6) : (memref<?x2600xf64>, index, index, memref<?x2000xf64>, index, f64, memref<?x2600xf64>) -> ()
          call @S0(%0) : (memref<1xf64>) -> ()
          call @S2(%0, %arg5, %arg7, %c0, %arg6, %arg8) : (memref<1xf64>, memref<?x2000xf64>, index, index, memref<?x2600xf64>, index) -> ()
          affine.for %arg9 = 1 to #map(%arg7) {
            call @S1(%arg4, %arg9, %arg8, %arg5, %arg7, %arg2, %arg6) : (memref<?x2600xf64>, index, index, memref<?x2000xf64>, index, f64, memref<?x2600xf64>) -> ()
            call @S2(%0, %arg5, %arg7, %arg9, %arg6, %arg8) : (memref<1xf64>, memref<?x2000xf64>, index, index, memref<?x2600xf64>, index) -> ()
          }
          call @S3(%arg4, %arg7, %arg8, %arg2, %0, %arg5, %arg6, %arg3) : (memref<?x2600xf64>, index, index, f64, memref<1xf64>, memref<?x2000xf64>, memref<?x2600xf64>, f64) -> ()
        }
      }
    }
    return
