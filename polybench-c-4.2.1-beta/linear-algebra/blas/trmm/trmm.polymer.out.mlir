...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @main(%arg0: i32, %arg1: !llvm.ptr<ptr<i8>>) -> i32 {
    ...
    call @kernel_trmm_opt(%c2000_i32, %c2600_i32, %6, %4, %5) : (i32, i32, f64, memref<?x2000xf64>, memref<?x2600xf64>) -> ()
    ...
    affine.for %arg5 = 0 to %0 {
      affine.for %arg6 = 0 to %1 {
        affine.for %arg7 = #map0(%arg5) to %0 {
          call @S0(%arg4, %arg5, %arg6, %arg7, %arg3) : (memref<?x2600xf64>, index, index, index, memref<?x2000xf64>) -> ()
        }
        call @S1(%arg4, %arg5, %arg6, %arg2) : (memref<?x2600xf64>, index, index, f64) -> ()
      }
    }
    return
  }
  ...
  func private @S0(%arg0: memref<?x2600xf64>, %arg1: index, %arg2: index, %arg3: index, %arg4: memref<?x2000xf64>) attributes {scop.stmt} {
    %0 = affine.load %arg0[symbol(%arg1), symbol(%arg2)] : memref<?x2600xf64>
    %1 = affine.load %arg4[symbol(%arg3), symbol(%arg1)] : memref<?x2000xf64>
    %2 = affine.load %arg0[symbol(%arg3), symbol(%arg2)] : memref<?x2600xf64>
    %3 = mulf %1, %2 : f64
    %4 = addf %0, %3 : f64
    affine.store %4, %arg0[symbol(%arg1), symbol(%arg2)] : memref<?x2600xf64>
    return
  }
  func private @S1(%arg0: memref<?x2600xf64>, %arg1: index, %arg2: index, %arg3: f64) attributes {scop.stmt} {
    %0 = affine.load %arg0[symbol(%arg1), symbol(%arg2)] : memref<?x2600xf64>
    %1 = mulf %arg3, %0 : f64
    affine.store %1, %arg0[symbol(%arg1), symbol(%arg2)] : memref<?x2600xf64>
    return
  }
  func private @kernel_trmm_opt(%arg0: i32, %arg1: i32, %arg2: f64, %arg3: memref<?x2000xf64>, %arg4: memref<?x2600xf64>) {
    %0 = index_cast %arg0 : i32 to index
    %1 = index_cast %arg1 : i32 to index
    affine.if #set()[%0, %1] {
            ...
            affine.for %arg8 = #map4(%arg6) to min #map5(%arg6, %arg7)[%0] {
              affine.for %arg9 = max #map6(%arg7, %arg8) to min #map7(%arg7)[%0] {
                affine.for %arg10 = #map4(%arg5) to min #map7(%arg5)[%1] {
                  call @S0(%arg4, %arg8, %arg10, %arg9, %arg3) : (memref<?x2600xf64>, index, index, index, memref<?x2000xf64>) -> ()
                }
              }
            }
          }
        ...
        affine.for %arg6 = 0 to #map1()[%1] {
          affine.for %arg7 = #map4(%arg5) to min #map7(%arg5)[%0] {
            affine.for %arg8 = #map4(%arg6) to min #map7(%arg6)[%1] {
              call @S1(%arg4, %arg7, %arg8, %arg2) : (memref<?x2600xf64>, index, index, f64) -> ()
            }
          }
        }
      }
