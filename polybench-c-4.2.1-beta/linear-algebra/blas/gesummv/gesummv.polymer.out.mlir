    ...
    affine.if #set()[%0] {
      affine.for %arg8 = 0 to #map0()[%0] {
        affine.for %arg9 = #map1(%arg8) to min #map2(%arg8)[%0] {
          ...
          call @S1(%arg7, %arg9, %arg5) : (memref<?xf64>, index, memref<?xf64>) -> ()
        }
      }
      affine.for %arg8 = 0 to #map0()[%0] {
        affine.for %arg9 = 0 to #map0()[%0] {
          affine.for %arg10 = #map1(%arg8) to min #map2(%arg8)[%0] {
            affine.for %arg11 = #map1(%arg9) to min #map2(%arg9)[%0] {
              call @S3(%arg7, %arg10, %arg6, %arg11, %arg4) : (memref<?xf64>, index, memref<?xf64>, index, memref<?x2800xf64>) -> ()
              call @S2(%arg5, %arg10, %arg6, %arg11, %arg3) : (memref<?xf64>, index, memref<?xf64>, index, memref<?x2800xf64>) -> ()
            }
          }
        }
      }
      affine.for %arg8 = 0 to #map0()[%0] {
        affine.for %arg9 = #map1(%arg8) to min #map2(%arg8)[%0] {
          call @S4(%arg7, %arg9, %arg2, %arg1, %arg5) : (memref<?xf64>, index, f64, f64, memref<?xf64>) -> ()
        }
      }
    }
    return
