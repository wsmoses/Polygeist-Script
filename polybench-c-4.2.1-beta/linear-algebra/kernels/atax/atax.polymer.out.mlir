    ...
    affine.if #set()[%1, %0] {
      affine.for %arg6 = 0 to #map0()[%0] {
        affine.for %arg7 = #map1(%arg6) to min #map2(%arg6)[%0] {
          call @S1(%arg5, %arg7) : (memref<?xf64>, index) -> ()
        }
      }
      affine.for %arg6 = 0 to #map0()[%0] {
        affine.for %arg7 = 0 to #map0()[%1] {
          affine.for %arg8 = #map1(%arg6) to min #map2(%arg6)[%0] {
            affine.for %arg9 = #map1(%arg7) to min #map2(%arg7)[%1] {
              call @S2(%arg5, %arg8, %arg3, %arg9, %arg2) : (memref<?xf64>, index, memref<?xf64>, index, memref<?x2200xf64>) -> ()
            }
          }
        }
      }
      affine.for %arg6 = 0 to #map0()[%1] {
        affine.for %arg7 = #map1(%arg6) to min #map2(%arg6)[%1] {
          call @S0(%arg4, %arg7) : (memref<?xf64>, index) -> ()
        }
      }
      affine.for %arg6 = 0 to #map0()[%1] {
        affine.for %arg7 = 0 to #map0()[%0] {
          affine.for %arg8 = #map1(%arg7) to min #map2(%arg7)[%0] {
            affine.for %arg9 = #map1(%arg6) to min #map2(%arg6)[%1] {
              call @S3(%arg4, %arg9, %arg5, %arg8, %arg2) : (memref<?xf64>, index, memref<?xf64>, index, memref<?x2200xf64>) -> ()
            }
          }
        }
      }
