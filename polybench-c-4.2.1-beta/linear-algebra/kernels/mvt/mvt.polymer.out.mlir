        ...
        affine.for %arg7 = 0 to #map0()[%0] {
          affine.for %arg8 = #map1(%arg6) to min #map2(%arg6)[%0] {
            affine.for %arg9 = #map1(%arg7) to min #map2(%arg7)[%0] {
              call @S0(%arg1, %arg8, %arg3, %arg9, %arg5) : (memref<?xf64>, index, memref<?xf64>, index, memref<?x4000xf64>) -> ()
              call @S1(%arg2, %arg8, %arg4, %arg9, %arg5) : (memref<?xf64>, index, memref<?xf64>, index, memref<?x4000xf64>) -> ()
            }
          }
        }
      }
