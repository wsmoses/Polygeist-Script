...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @main(%arg0: i32, %arg1: !llvm.ptr<ptr<i8>>) -> i32 {
    ...
    call @kernel_doitgen_opt(%c250_i32, %c220_i32, %c270_i32, %3, %4, %5) : (i32, i32, i32, memref<?x220x270xf64>, memref<?x270xf64>, memref<?xf64>) -> ()
      ...
      affine.for %arg7 = 0 to %0 {
        affine.for %arg8 = 0 to %1 {
          ...
          affine.for %arg9 = 0 to %1 {
            call @S1(%arg5, %arg8, %arg4, %arg9, %arg3, %arg6, %arg7) : (memref<?xf64>, index, memref<?x270xf64>, index, memref<?x220x270xf64>, index, index) -> ()
          }
        }
        affine.for %arg8 = 0 to %1 {
          call @S2(%arg3, %arg6, %arg7, %arg8, %arg5) : (memref<?x220x270xf64>, index, index, index, memref<?xf64>) -> ()
        }
      }
    }
    return
  ...
  func private @S1(%arg0: memref<?xf64>, %arg1: index, %arg2: memref<?x270xf64>, %arg3: index, %arg4: memref<?x220x270xf64>, %arg5: index, %arg6: index) attributes {scop.stmt} {
    %0 = affine.load %arg0[symbol(%arg1)] : memref<?xf64>
    %1 = affine.load %arg4[symbol(%arg5), symbol(%arg6), symbol(%arg3)] : memref<?x220x270xf64>
    %2 = affine.load %arg2[symbol(%arg3), symbol(%arg1)] : memref<?x270xf64>
    %3 = mulf %1, %2 : f64
    %4 = addf %0, %3 : f64
    affine.store %4, %arg0[symbol(%arg1)] : memref<?xf64>
    return
  }
  func private @S2(%arg0: memref<?x220x270xf64>, %arg1: index, %arg2: index, %arg3: index, %arg4: memref<?xf64>) attributes {scop.stmt} {
    %0 = affine.load %arg4[symbol(%arg3)] : memref<?xf64>
    affine.store %0, %arg0[symbol(%arg1), symbol(%arg2), symbol(%arg3)] : memref<?x220x270xf64>
    return
  }
  func private @kernel_doitgen_opt(%arg0: i32, %arg1: i32, %arg2: i32, %arg3: memref<?x220x270xf64>, %arg4: memref<?x270xf64>, %arg5: memref<?xf64>) {
        ...
        affine.for %arg7 = 0 to %1 {
          affine.for %arg8 = 0 to #map0()[%2] {
            affine.for %arg9 = #map1(%arg8) to min #map2(%arg8)[%2] {
              call @S0(%arg5, %arg9) : (memref<?xf64>, index) -> ()
            }
          }
          affine.for %arg8 = 0 to #map0()[%2] {
            affine.for %arg9 = 0 to #map0()[%2] {
              affine.for %arg10 = #map1(%arg9) to min #map2(%arg9)[%2] {
                affine.for %arg11 = #map1(%arg8) to min #map2(%arg8)[%2] {
                  call @S1(%arg5, %arg11, %arg4, %arg10, %arg3, %arg6, %arg7) : (memref<?xf64>, index, memref<?x270xf64>, index, memref<?x220x270xf64>, index, index) -> ()
                }
              }
            }
          }
          affine.for %arg8 = 0 to #map0()[%2] {
            affine.for %arg9 = #map1(%arg8) to min #map2(%arg8)[%2] {
              call @S2(%arg3, %arg6, %arg7, %arg9, %arg5) : (memref<?x220x270xf64>, index, index, index, memref<?xf64>) -> ()
            }
          }
        }
      }
