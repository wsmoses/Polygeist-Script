...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @main(%arg0: i32, %arg1: !llvm.ptr<ptr<i8>>) -> i32 {
    ...
    %3 = memref.cast %0 : memref<4000x4000xf64> to memref<?x4000xf64>
    %4 = memref.cast %1 : memref<4000xf64> to memref<?xf64>
    %5 = memref.cast %2 : memref<4000xf64> to memref<?xf64>
    call @init_array(%c4000_i32, %3, %4, %5) : (i32, memref<?x4000xf64>, memref<?xf64>, memref<?xf64>) -> ()
    call @polybench_timer_start() : () -> ()
    call @kernel_trisolv_opt(%c4000_i32, %3, %4, %5) : (i32, memref<?x4000xf64>, memref<?xf64>, memref<?xf64>) -> ()
  ...
  func private @init_array(%arg0: i32, %arg1: memref<?x4000xf64>, %arg2: memref<?xf64>, %arg3: memref<?xf64>) {
    %c0_i32 = constant 0 : i32
    %c-999_i32 = constant -999 : i32
    %c2_i32 = constant 2 : i32
    %c1_i32 = constant 1 : i32
    %0 = scf.while (%arg4 = %c0_i32) : (i32) -> i32 {
      %1 = cmpi slt, %arg4, %arg0 : i32
      scf.condition(%1) %arg4 : i32
    } do {
    ^bb0(%arg4: i32):  // no predecessors
      %1 = index_cast %arg4 : i32 to index
      %2 = sitofp %c-999_i32 : i32 to f64
      memref.store %2, %arg2[%1] : memref<?xf64>
      %3 = sitofp %arg4 : i32 to f64
      memref.store %3, %arg3[%1] : memref<?xf64>
      %4 = scf.while (%arg5 = %c0_i32) : (i32) -> i32 {
        %6 = cmpi sle, %arg5, %arg4 : i32
        scf.condition(%6) %arg5 : i32
      } do {
      ^bb0(%arg5: i32):  // no predecessors
        %6 = index_cast %arg5 : i32 to index
        %7 = addi %arg4, %arg0 : i32
        %8 = subi %7, %arg5 : i32
        %9 = addi %8, %c1_i32 : i32
        %10 = sitofp %9 : i32 to f64
        %11 = sitofp %c2_i32 : i32 to f64
        %12 = mulf %10, %11 : f64
        %13 = sitofp %arg0 : i32 to f64
        %14 = divf %12, %13 : f64
        memref.store %14, %arg1[%1, %6] : memref<?x4000xf64>
        %15 = addi %arg5, %c1_i32 : i32
        scf.yield %15 : i32
      }
      %5 = addi %arg4, %c1_i32 : i32
      scf.yield %5 : i32
    }
    return
  }
  func private @polybench_timer_start()
  func private @kernel_trisolv(%arg0: i32, %arg1: memref<?x4000xf64>, %arg2: memref<?xf64>, %arg3: memref<?xf64>) {
    %0 = index_cast %arg0 : i32 to index
    affine.for %arg4 = 0 to %0 {
      call @S0(%arg2, %arg4, %arg3) : (memref<?xf64>, index, memref<?xf64>) -> ()
      affine.for %arg5 = 0 to #map0(%arg4) {
        call @S1(%arg2, %arg4, %arg5, %arg1) : (memref<?xf64>, index, index, memref<?x4000xf64>) -> ()
      }
      call @S2(%arg2, %arg4, %arg1) : (memref<?xf64>, index, memref<?x4000xf64>) -> ()
    }
    return
  }
  ...
  func private @kernel_trisolv_opt(%arg0: i32, %arg1: memref<?x4000xf64>, %arg2: memref<?xf64>, %arg3: memref<?xf64>) {
    %0 = index_cast %arg0 : i32 to index
    affine.if #set0()[%0] {
      affine.for %arg4 = 0 to #map1()[%0] {
        affine.for %arg5 = #map2(%arg4) to min #map3(%arg4)[%0] {
          call @S0(%arg2, %arg5, %arg3) : (memref<?xf64>, index, memref<?xf64>) -> ()
        }
      }
      affine.for %arg4 = 0 to #map1()[%0] {
          ...
          affine.if #set1(%arg4, %arg5) {
            affine.for %arg6 = #map2(%arg4) to min #map3(%arg4)[%0] {
              affine.for %arg7 = #map2(%arg5) to #map5(%arg5) {
                call @S1(%arg2, %arg6, %arg7, %arg1) : (memref<?xf64>, index, index, memref<?x4000xf64>) -> ()
              }
            }
          }
          affine.if #set2(%arg4, %arg5) {
            %1 = affine.apply #map2(%arg4)
            call @S2(%arg2, %1, %arg1) : (memref<?xf64>, index, memref<?x4000xf64>) -> ()
          }
          affine.if #set2(%arg4, %arg5) {
            affine.for %arg6 = #map6(%arg4) to min #map3(%arg4)[%0] {
              ...
              call @S2(%arg2, %arg6, %arg1) : (memref<?xf64>, index, memref<?x4000xf64>) -> ()
            }
          }
        }
      }
