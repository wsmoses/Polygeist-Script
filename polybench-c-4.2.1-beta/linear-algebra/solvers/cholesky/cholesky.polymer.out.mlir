...
#set1 = affine_set<(d0, d1, d2) : (d0 - (d1 + 1) >= 0, d1 - d2 == 0)>
#set2 = affine_set<(d0, d1) : (d0 - (d1 + 1) >= 0)>
#set3 = affine_set<(d0, d1, d2) : (d0 - d1 == 0, d0 - (d2 + 1) >= 0)>
#set4 = affine_set<(d0, d1, d2) : (d0 - d1 == 0, d0 - d2 == 0)>
#set5 = affine_set<(d0, d1, d2)[s0] : (d0 - d1 == 0, d0 - d2 == 0, -d0 + (s0 - 2) floordiv 32 >= 0)>
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @main(%arg0: i32, %arg1: !llvm.ptr<ptr<i8>>) -> i32 {
    ...
    call @kernel_cholesky_opt(%c4000_i32, %1) : (i32, memref<?x4000xf64>) -> ()
  ...
  func private @kernel_cholesky(%arg0: i32, %arg1: memref<?x4000xf64>) {
    ...
    affine.for %arg2 = 0 to %0 {
      ...
      affine.for %arg3 = 0 to #map0(%arg2) {
        call @S2(%arg1, %arg2, %arg3) : (memref<?x4000xf64>, index, index) -> ()
      }
      call @S3(%arg1, %arg2) : (memref<?x4000xf64>, index) -> ()
    }
    return
  }
  ...
  func private @kernel_cholesky_opt(%arg0: i32, %arg1: memref<?x4000xf64>) {
    %0 = index_cast %arg0 : i32 to index
    affine.if #set0()[%0] {
      affine.for %arg2 = 0 to #map1()[%0] {
        affine.for %arg3 = 0 to #map2(%arg2) {
          affine.for %arg4 = max #map3(%arg3)[%0] to #map2(%arg2) {
              ...
              affine.for %arg5 = #map4(%arg2) to min #map5(%arg2)[%0] {
                ...
                affine.for %arg6 = #map6(%arg3) to #map7(%arg3) {
                  affine.for %arg7 = #map4(%arg3) to #map0(%arg6) {
                    call @S0(%arg1, %arg5, %arg6, %arg7) : (memref<?x4000xf64>, index, index, index) -> ()
                  }
            ...
            affine.if #set3(%arg2, %arg4, %arg3) {
              affine.for %arg5 = #map4(%arg2) to min #map5(%arg2)[%0] {
                affine.for %arg6 = #map4(%arg3) to #map7(%arg3) {
                  call @S2(%arg1, %arg5, %arg6) : (memref<?x4000xf64>, index, index) -> ()
                }
              }
            }
            affine.if #set4(%arg2, %arg3, %arg4) {
              %1 = affine.apply #map4(%arg2)
              call @S3(%arg1, %1) : (memref<?x4000xf64>, index) -> ()
            }
            affine.if #set5(%arg2, %arg3, %arg4)[%0] {
              ...
              call @S2(%arg1, %3, %4) : (memref<?x4000xf64>, index, index) -> ()
              %5 = affine.apply #map6(%arg2)
              call @S3(%arg1, %5) : (memref<?x4000xf64>, index) -> ()
            }
            affine.if #set4(%arg2, %arg3, %arg4) {
              affine.for %arg5 = #map10(%arg2) to min #map5(%arg2)[%0] {
                ...
                call @S1(%arg1, %arg5, %1) : (memref<?x4000xf64>, index, index) -> ()
                %2 = affine.apply #map4(%arg2)
                call @S2(%arg1, %arg5, %2) : (memref<?x4000xf64>, index, index) -> ()
                ...
                call @S3(%arg1, %arg5) : (memref<?x4000xf64>, index) -> ()
              }
            }
          }
        }
