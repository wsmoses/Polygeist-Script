...
entry:
  ...
  call void @kernel_cholesky(i32 %5, [4000 x double]* %arraydecay1)
...
for.body30:                                       ; preds = %for.cond28
  ...
  %35 = load i32, i32* %k, align 4, !tbaa !2
  %idxprom33 = sext i32 %35 to i64
  %arrayidx34 = getelementptr inbounds [4000 x double], [4000 x double]* %arrayidx32, i64 0, i64 %idxprom33
  %36 = load double, double* %arrayidx34, align 8, !tbaa !10
  %37 = load [4000 x double]*, [4000 x double]** %A.addr, align 8, !tbaa !6
  %38 = load i32, i32* %i, align 4, !tbaa !2
  %idxprom35 = sext i32 %38 to i64
  %arrayidx36 = getelementptr inbounds [4000 x double], [4000 x double]* %37, i64 %idxprom35
  ...
  %40 = load double, double* %arrayidx38, align 8, !tbaa !10
  %mul39 = fmul double %36, %40
  %41 = load [4000 x double]*, [4000 x double]** %A.addr, align 8, !tbaa !6
  %42 = load i32, i32* %i, align 4, !tbaa !2
  %idxprom40 = sext i32 %42 to i64
  %arrayidx41 = getelementptr inbounds [4000 x double], [4000 x double]* %41, i64 %idxprom40
  ...
  %44 = load double, double* %arrayidx43, align 8, !tbaa !10
  %sub44 = fsub double %44, %mul39
  store double %sub44, double* %arrayidx43, align 8, !tbaa !10
  br label %for.inc45

for.inc45:                                        ; preds = %for.body30
  %45 = load i32, i32* %k, align 4, !tbaa !2
  %inc46 = add nsw i32 %45, 1
  store i32 %inc46, i32* %k, align 4, !tbaa !2
...
for.end47:                                        ; preds = %for.cond28
  ...
  %49 = load double, double* %arrayidx51, align 8, !tbaa !10
  %call = call double @sqrt(double %49) #6
  %50 = load [4000 x double]*, [4000 x double]** %A.addr, align 8, !tbaa !6
  %51 = load i32, i32* %i, align 4, !tbaa !2
  %idxprom52 = sext i32 %51 to i64
  %arrayidx53 = getelementptr inbounds [4000 x double], [4000 x double]* %50, i64 %idxprom52
  ...
  store double %call, double* %arrayidx55, align 8, !tbaa !10
  br label %for.inc56
