...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @main(%arg0: i32, %arg1: !llvm.ptr<ptr<i8>>) -> i32 {
    ...
    call @kernel_durbin(%c4000_i32, %2, %3) : (i32, memref<?xf64>, memref<?xf64>) -> ()
  ...
  func private @kernel_durbin(%arg0: i32, %arg1: memref<?xf64>, %arg2: memref<?xf64>) {
    ...
    affine.for %arg3 = 1 to %6 {
      %7 = sitofp %c1_i32 : i32 to f64
      %8 = affine.load %1[0] : memref<1xf64>
      %9 = mulf %8, %8 : f64
      %10 = subf %7, %9 : f64
      %11 = affine.load %2[0] : memref<1xf64>
      %12 = mulf %10, %11 : f64
      affine.store %12, %2[0] : memref<1xf64>
      ...
      affine.for %arg4 = 0 to #map(%arg3) {
        ...
        %20 = mulf %18, %19 : f64
        %21 = affine.load %3[0] : memref<1xf64>
        %22 = addf %21, %20 : f64
        affine.store %22, %3[0] : memref<1xf64>
      }
      %13 = affine.load %arg1[%arg3] : memref<?xf64>
      %14 = affine.load %3[0] : memref<1xf64>
      %15 = addf %13, %14 : f64
      %16 = negf %15 : f64
      %17 = divf %16, %12 : f64
      affine.store %17, %1[0] : memref<1xf64>
      affine.for %arg4 = 0 to #map(%arg3) {
        %18 = affine.load %arg2[%arg4] : memref<?xf64>
        %19 = affine.load %arg2[%arg3 - %arg4 - 1] : memref<?xf64>
        %20 = mulf %17, %19 : f64
        %21 = addf %18, %20 : f64
        affine.store %21, %0[%arg4] : memref<4000xf64>
      }
      affine.for %arg4 = 0 to #map(%arg3) {
        %18 = affine.load %0[%arg4] : memref<4000xf64>
        affine.store %18, %arg2[%arg4] : memref<?xf64>
      }
      affine.store %17, %arg2[%arg3] : memref<?xf64>
    }
    return
  }
