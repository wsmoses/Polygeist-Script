...
for.end79.i:                                      ; preds = %for.end79.i.loopexit.unr-lcssa, %for.body68.i.epil, %for.body63.i
  ...
  br i1 %exitcond48.not.i, label %for.body88.i.preheader, label %for.body63.i, !llvm.loop !23

for.body88.i.preheader:                           ; preds = %for.end79.i
  %arraydecay5 = bitcast i8* %call.i30 to double*
  br label %for.body88.i

for.body88.i:                                     ; preds = %for.body88.i.preheader, %for.end104.i
  %indvar = phi i64 [ 0, %for.body88.i.preheader ], [ %indvar.next, %for.end104.i ]
  %indvars.iv49.i = phi i64 [ 3999, %for.body88.i.preheader ], [ %indvars.iv.next50.i, %for.end104.i ]
  %74 = add i64 %indvar, -1
