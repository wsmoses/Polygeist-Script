...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @main(%arg0: i32, %arg1: !llvm.ptr<ptr<i8>>) -> i32 {
    ...
    call @kernel_ludcmp(%c4000_i32, %4, %5, %6, %7) : (i32, memref<?x4000xf64>, memref<?xf64>, memref<?xf64>, memref<?xf64>) -> ()
  ...
  func private @kernel_ludcmp(%arg0: i32, %arg1: memref<?x4000xf64>, %arg2: memref<?xf64>, %arg3: memref<?xf64>, %arg4: memref<?xf64>) {
    ...
    affine.for %arg5 = 0 to %0 {
      affine.for %arg6 = 0 to #map0(%arg5) {
        %2 = affine.load %arg1[%arg5, %arg6] : memref<?x4000xf64>
        affine.store %2, %1[0] : memref<1xf64>
        affine.for %arg7 = 0 to #map0(%arg6) {
          %6 = affine.load %arg1[%arg5, %arg7] : memref<?x4000xf64>
          %7 = affine.load %arg1[%arg7, %arg6] : memref<?x4000xf64>
          %8 = mulf %6, %7 : f64
        ...
        %4 = affine.load %arg1[%arg6, %arg6] : memref<?x4000xf64>
        %5 = divf %3, %4 : f64
        affine.store %5, %arg1[%arg5, %arg6] : memref<?x4000xf64>
      }
      affine.for %arg6 = #map0(%arg5) to %0 {
        %2 = affine.load %arg1[%arg5, %arg6] : memref<?x4000xf64>
        affine.store %2, %1[0] : memref<1xf64>
        affine.for %arg7 = 0 to #map0(%arg5) {
          %4 = affine.load %arg1[%arg5, %arg7] : memref<?x4000xf64>
          %5 = affine.load %arg1[%arg7, %arg6] : memref<?x4000xf64>
          %6 = mulf %4, %5 : f64
        ...
        %3 = affine.load %1[0] : memref<1xf64>
        affine.store %3, %arg1[%arg5, %arg6] : memref<?x4000xf64>
      }
    }
    affine.for %arg5 = 0 to %0 {
      ...
      affine.store %2, %1[0] : memref<1xf64>
      affine.for %arg6 = 0 to #map0(%arg5) {
        %4 = affine.load %arg1[%arg5, %arg6] : memref<?x4000xf64>
    ...
    affine.for %arg5 = 0 to %0 {
      ...
      affine.for %arg6 = #map1(%arg5)[%0] to %0 {
        %6 = affine.load %arg1[-%arg5 + symbol(%0) - 1, %arg6] : memref<?x4000xf64>
      ...
      %3 = affine.load %1[0] : memref<1xf64>
      %4 = affine.load %arg1[-%arg5 + symbol(%0) - 1, -%arg5 + symbol(%0) - 1] : memref<?x4000xf64>
      %5 = divf %3, %4 : f64
