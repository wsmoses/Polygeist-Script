...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @main(%arg0: i32, %arg1: !llvm.ptr<ptr<i8>>) -> i32 {
    ...
    call @kernel_lu(%c4000_i32, %1) : (i32, memref<?x4000xf64>) -> ()
    ...
    affine.for %arg2 = 0 to %0 {
      affine.for %arg3 = 0 to #map(%arg2) {
        affine.for %arg4 = 0 to #map(%arg3) {
          %4 = affine.load %arg1[%arg2, %arg4] : memref<?x4000xf64>
          %5 = affine.load %arg1[%arg4, %arg3] : memref<?x4000xf64>
          %6 = mulf %4, %5 : f64
          %7 = affine.load %arg1[%arg2, %arg3] : memref<?x4000xf64>
          %8 = subf %7, %6 : f64
          affine.store %8, %arg1[%arg2, %arg3] : memref<?x4000xf64>
        }
        %1 = affine.load %arg1[%arg3, %arg3] : memref<?x4000xf64>
        %2 = affine.load %arg1[%arg2, %arg3] : memref<?x4000xf64>
        %3 = divf %2, %1 : f64
        affine.store %3, %arg1[%arg2, %arg3] : memref<?x4000xf64>
      }
      affine.for %arg3 = #map(%arg2) to %0 {
        affine.for %arg4 = 0 to #map(%arg2) {
          %1 = affine.load %arg1[%arg2, %arg4] : memref<?x4000xf64>
          %2 = affine.load %arg1[%arg4, %arg3] : memref<?x4000xf64>
          %3 = mulf %1, %2 : f64
