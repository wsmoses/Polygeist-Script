...
#map10 = affine_map<(d0, d1) -> (d0 * 32, d1 * 32 + 1)>
#map11 = affine_map<(d0, d1) -> (d0 * 32 + 1, d1 * 32 + 32)>
#map12 = affine_map<(d0, d1) -> (d0 * 32 + 32, d1)>
#map13 = affine_map<(d0) -> (d0 * 32 + 2)>
#map14 = affine_map<(d0) -> (d0 - 1)>
...
#set4 = affine_set<(d0, d1, d2) : (d0 - d1 == 0, d0 - (d2 + 1) >= 0)>
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @main(%arg0: i32, %arg1: !llvm.ptr<ptr<i8>>) -> i32 {
    ...
    call @kernel_lu_opt(%c4000_i32, %1) : (i32, memref<?x4000xf64>) -> ()
  ...
  func private @kernel_lu(%arg0: i32, %arg1: memref<?x4000xf64>) {
    %0 = index_cast %arg0 : i32 to index
    affine.for %arg2 = 0 to %0 {
      affine.for %arg3 = 0 to #map0(%arg2) {
        affine.for %arg4 = 0 to #map0(%arg3) {
          call @S0(%arg1, %arg2, %arg3, %arg4) : (memref<?x4000xf64>, index, index, index) -> ()
        }
        call @S1(%arg1, %arg2, %arg3) : (memref<?x4000xf64>, index, index) -> ()
      }
      affine.for %arg3 = #map0(%arg2) to %0 {
        affine.for %arg4 = 0 to #map0(%arg2) {
          call @S2(%arg1, %arg2, %arg3, %arg4) : (memref<?x4000xf64>, index, index, index) -> ()
        }
      }
    }
    return
  ...
  func private @kernel_lu_opt(%arg0: i32, %arg1: memref<?x4000xf64>) {
    %0 = index_cast %arg0 : i32 to index
    affine.if #set0()[%0] {
        ...
        affine.for %arg3 = 0 to #map1()[%0] {
          affine.for %arg4 = 0 to min #map2(%arg2, %arg3)[%0] {
            affine.if #set1(%arg3, %arg4) {
              affine.for %arg5 = max #map3(%arg2, %arg3) to min #map4(%arg2)[%0] {
                affine.for %arg6 = #map5(%arg3) to #map6(%arg3) {
                  call @S1(%arg1, %arg5, %arg6) : (memref<?x4000xf64>, index, index) -> ()
                  affine.for %arg7 = #map7(%arg6) to #map8(%arg3) {
                    call @S0(%arg1, %arg5, %arg7, %arg6) : (memref<?x4000xf64>, index, index, index) -> ()
                  }
                }
                %1 = affine.apply #map6(%arg3)
                call @S1(%arg1, %arg5, %1) : (memref<?x4000xf64>, index, index) -> ()
              }
            }
            ...
            affine.if #set3(%arg2, %arg3, %arg4) {
              ...
              call @S1(%arg1, %1, %2) : (memref<?x4000xf64>, index, index) -> ()
              affine.for %arg5 = #map9(%arg2) to min #map4(%arg2)[%0] {
                %3 = affine.apply #map9(%arg2)
                %4 = affine.apply #map5(%arg2)
                call @S2(%arg1, %3, %arg5, %4) : (memref<?x4000xf64>, index, index, index) -> ()
              }
            }
            affine.for %arg5 = max #map10(%arg2, %arg4) to min #map11(%arg3, %arg2) {
              affine.for %arg6 = #map5(%arg4) to min #map12(%arg4, %arg5) {
                affine.for %arg7 = #map5(%arg3) to min #map4(%arg3)[%0] {
                  call @S2(%arg1, %arg5, %arg7, %arg6) : (memref<?x4000xf64>, index, index, index) -> ()
                }
              }
            }
            affine.if #set3(%arg2, %arg3, %arg4) {
              affine.for %arg5 = #map13(%arg2) to min #map4(%arg2)[%0] {
                affine.for %arg6 = #map5(%arg2) to #map14(%arg5) {
                  call @S1(%arg1, %arg5, %arg6) : (memref<?x4000xf64>, index, index) -> ()
                  affine.for %arg7 = #map7(%arg6) to #map0(%arg5) {
                    call @S0(%arg1, %arg5, %arg7, %arg6) : (memref<?x4000xf64>, index, index, index) -> ()
                  }
                  affine.for %arg7 = #map0(%arg5) to min #map4(%arg2)[%0] {
                    call @S2(%arg1, %arg5, %arg7, %arg6) : (memref<?x4000xf64>, index, index, index) -> ()
                  }
                }
                %1 = affine.apply #map14(%arg5)
                call @S1(%arg1, %arg5, %1) : (memref<?x4000xf64>, index, index) -> ()
                affine.for %arg6 = #map0(%arg5) to min #map4(%arg2)[%0] {
                  %2 = affine.apply #map14(%arg5)
                  call @S2(%arg1, %arg5, %arg6, %2) : (memref<?x4000xf64>, index, index, index) -> ()
                }
              }
            }
