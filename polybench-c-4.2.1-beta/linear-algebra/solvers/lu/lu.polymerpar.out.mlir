...
#map1 = affine_map<(d0) -> (125, d0 + 1)>
#map2 = affine_map<(d0, d1) -> (125, d0 + 1, d1 - d0 + 1)>
#map3 = affine_map<(d0, d1) -> (d0 * 32 - d1 * 32, d1 * 32 + 32)>
#map4 = affine_map<(d0, d1) -> (4000, d0 * 32 - d1 * 32 + 32)>
#map5 = affine_map<(d0) -> (d0 * 32)>
#map6 = affine_map<(d0) -> (d0 * 32 + 31)>
#map7 = affine_map<(d0) -> (d0 + 1)>
#map8 = affine_map<(d0) -> (d0 * 32 + 32)>
#map9 = affine_map<(d0) -> (d0 * 16 + 1)>
#map10 = affine_map<(d0) -> (4000, d0 * 16 + 32)>
#map11 = affine_map<(d0, d1, d2) -> (d0 * 32 - d1 * 32, d2 * 32 + 1)>
#map12 = affine_map<(d0, d1) -> (d0 * 32 + 1, d1 * 32 - d0 * 32 + 32)>
#map13 = affine_map<(d0, d1) -> (d0 * 32 + 32, d1)>
#map14 = affine_map<(d0) -> (4000, d0 * 32 + 32)>
...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @main(%arg0: i32, %arg1: !llvm.ptr<ptr<i8>>) -> i32 {
    ...
    affine.for %arg2 = 0 to 250 {
      affine.for %arg3 = max #map0(%arg2) to min #map1(%arg2) {
        affine.for %arg4 = 0 to min #map2(%arg3, %arg2) {
          affine.if #set0(%arg3, %arg4) {
            affine.for %arg5 = max #map3(%arg2, %arg3) to min #map4(%arg2, %arg3) {
              affine.for %arg6 = #map5(%arg3) to #map6(%arg3) {
                ...
                affine.for %arg7 = #map7(%arg6) to #map8(%arg3) {
                  %12 = affine.load %0[%arg5, %arg7] : memref<4000x4000xf64>
                  %13 = affine.load %0[%arg5, %arg6] : memref<4000x4000xf64>
                  %14 = affine.load %0[%arg6, %arg7] : memref<4000x4000xf64>
                  %15 = mulf %13, %14 : f64
                  %16 = subf %12, %15 : f64
                  affine.store %16, %0[%arg5, %arg7] : memref<4000x4000xf64>
                }
              }
              %6 = affine.load %0[%arg5, %arg3 * 32 + 31] : memref<4000x4000xf64>
              %7 = affine.load %0[%arg3 * 32 + 31, %arg3 * 32 + 31] : memref<4000x4000xf64>
              %8 = divf %6, %7 : f64
              affine.store %8, %0[%arg5, %arg3 * 32 + 31] : memref<4000x4000xf64>
            }
          }
          affine.if #set1(%arg3, %arg4) {
            affine.for %arg5 = max #map3(%arg2, %arg3) to min #map4(%arg2, %arg3) {
              affine.for %arg6 = #map5(%arg4) to #map8(%arg4) {
                affine.for %arg7 = #map5(%arg3) to #map8(%arg3) {
                  %6 = affine.load %0[%arg5, %arg7] : memref<4000x4000xf64>
                  %7 = affine.load %0[%arg5, %arg6] : memref<4000x4000xf64>
                  %8 = affine.load %0[%arg6, %arg7] : memref<4000x4000xf64>
                  %9 = mulf %7, %8 : f64
                  %10 = subf %6, %9 : f64
                  affine.store %10, %0[%arg5, %arg7] : memref<4000x4000xf64>
                }
              }
            }
          }
          affine.if #set2(%arg2, %arg3, %arg4) {
            ...
            affine.for %arg5 = #map9(%arg2) to min #map10(%arg2) {
              affine.if #set3(%arg2) {
                %6 = affine.load %0[%arg2 * 16 + 1, %arg5] : memref<4000x4000xf64>
                %7 = affine.load %0[%arg2 * 16 + 1, %arg2 * 16] : memref<4000x4000xf64>
                %8 = affine.load %0[%arg2 * 16, %arg5] : memref<4000x4000xf64>
                %9 = mulf %7, %8 : f64
                %10 = subf %6, %9 : f64
                affine.store %10, %0[%arg2 * 16 + 1, %arg5] : memref<4000x4000xf64>
              }
            }
          }
          affine.for %arg5 = max #map11(%arg2, %arg3, %arg4) to min #map12(%arg3, %arg2) {
            affine.for %arg6 = #map5(%arg4) to min #map13(%arg4, %arg5) {
              affine.for %arg7 = #map5(%arg3) to min #map14(%arg3) {
                %6 = affine.load %0[%arg5, %arg7] : memref<4000x4000xf64>
                %7 = affine.load %0[%arg5, %arg6] : memref<4000x4000xf64>
                %8 = affine.load %0[%arg6, %arg7] : memref<4000x4000xf64>
                %9 = mulf %7, %8 : f64
          ...
          affine.if #set2(%arg2, %arg3, %arg4) {
            affine.for %arg5 = #map15(%arg2) to min #map10(%arg2) {
              affine.for %arg6 = #map16(%arg2) to #map17(%arg5) {
                affine.if #set3(%arg2) {
                ...
                affine.for %arg7 = #map7(%arg6) to #map18(%arg5) {
                  affine.if #set3(%arg2) {
                    %6 = affine.load %0[%arg5, %arg7] : memref<4000x4000xf64>
                    %7 = affine.load %0[%arg5, %arg6] : memref<4000x4000xf64>
                    %8 = affine.load %0[%arg6, %arg7] : memref<4000x4000xf64>
                ...
                affine.for %arg7 = #map18(%arg5) to min #map10(%arg2) {
                  affine.if #set3(%arg2) {
                    %6 = affine.load %0[%arg5, %arg7] : memref<4000x4000xf64>
                    %7 = affine.load %0[%arg5, %arg6] : memref<4000x4000xf64>
                    %8 = affine.load %0[%arg6, %arg7] : memref<4000x4000xf64>
              ...
              affine.if #set3(%arg2) {
                %6 = affine.load %0[%arg5, %arg5 - 1] : memref<4000x4000xf64>
                %7 = affine.load %0[%arg5 - 1, %arg5 - 1] : memref<4000x4000xf64>
                %8 = divf %6, %7 : f64
                affine.store %8, %0[%arg5, %arg5 - 1] : memref<4000x4000xf64>
              }
              affine.for %arg6 = #map18(%arg5) to min #map10(%arg2) {
                affine.if #set3(%arg2) {
                  %6 = affine.load %0[%arg5, %arg6] : memref<4000x4000xf64>
                  %7 = affine.load %0[%arg5, %arg5 - 1] : memref<4000x4000xf64>
                  %8 = affine.load %0[%arg5 - 1, %arg6] : memref<4000x4000xf64>
                  %9 = mulf %7, %8 : f64
                  %10 = subf %6, %9 : f64
          ...
          affine.if #set4(%arg2, %arg3, %arg4) {
            affine.for %arg5 = #map9(%arg2) to min #map10(%arg2) {
              affine.for %arg6 = #map5(%arg4) to #map8(%arg4) {
                affine.for %arg7 = #map16(%arg2) to #map18(%arg5) {
                  affine.if #set3(%arg2) {
                    %6 = affine.load %0[%arg5, %arg7] : memref<4000x4000xf64>
                    %7 = affine.load %0[%arg5, %arg6] : memref<4000x4000xf64>
                    %8 = affine.load %0[%arg6, %arg7] : memref<4000x4000xf64>
  ...
  func private @S0(%arg0: memref<?x4000xf64>, %arg1: index, %arg2: index, %arg3: index) attributes {scop.stmt} {
    ...
    %2 = affine.load %arg0[symbol(%arg3), symbol(%arg2)] : memref<?x4000xf64>
    %3 = mulf %1, %2 : f64
    %4 = subf %0, %3 : f64
  ...
  func private @S2(%arg0: memref<?x4000xf64>, %arg1: index, %arg2: index, %arg3: index) attributes {scop.stmt} {
    %0 = affine.load %arg0[symbol(%arg1), symbol(%arg2)] : memref<?x4000xf64>
    %1 = affine.load %arg0[symbol(%arg1), symbol(%arg3)] : memref<?x4000xf64>
    %2 = affine.load %arg0[symbol(%arg3), symbol(%arg2)] : memref<?x4000xf64>
    %3 = mulf %1, %2 : f64
