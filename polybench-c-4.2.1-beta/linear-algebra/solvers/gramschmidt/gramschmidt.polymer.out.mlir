...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @main(%arg0: i32, %arg1: !llvm.ptr<ptr<i8>>) -> i32 {
    ...
    call @kernel_gramschmidt_opt(%c2000_i32, %c2600_i32, %3, %4, %5) : (i32, i32, memref<?x2600xf64>, memref<?x2600xf64>, memref<?x2600xf64>) -> ()
  ...
  func private @kernel_gramschmidt(%arg0: i32, %arg1: i32, %arg2: memref<?x2600xf64>, %arg3: memref<?x2600xf64>, %arg4: memref<?x2600xf64>) {
    ...
    affine.for %arg5 = 0 to %3 {
      ...
      affine.for %arg6 = 0 to %1 {
        call @S1(%2, %arg2, %arg6, %arg5) : (memref<1xf64>, memref<?x2600xf64>, index, index) -> ()
      }
      call @S2(%0, %2) : (memref<1xf64>, memref<1xf64>) -> ()
      call @S3(%arg3, %arg5, %0) : (memref<?x2600xf64>, index, memref<1xf64>) -> ()
      affine.for %arg6 = 0 to %1 {
        call @S4(%arg4, %arg6, %arg5, %0, %arg2) : (memref<?x2600xf64>, index, index, memref<1xf64>, memref<?x2600xf64>) -> ()
      }
      affine.for %arg6 = #map0(%arg5) to %3 {
        call @S5(%arg3, %arg5, %arg6) : (memref<?x2600xf64>, index, index) -> ()
        affine.for %arg7 = 0 to %1 {
          call @S6(%arg3, %arg5, %arg6, %arg2, %arg7, %arg4) : (memref<?x2600xf64>, index, index, memref<?x2600xf64>, index, memref<?x2600xf64>) -> ()
        }
        affine.for %arg7 = 0 to %1 {
          call @S7(%arg2, %arg7, %arg6, %arg3, %arg5, %arg4) : (memref<?x2600xf64>, index, index, memref<?x2600xf64>, index, memref<?x2600xf64>) -> ()
        }
      }
    }
    return
  ...
  func private @kernel_gramschmidt_opt(%arg0: i32, %arg1: i32, %arg2: memref<?x2600xf64>, %arg3: memref<?x2600xf64>, %arg4: memref<?x2600xf64>) {
    %0 = memref.alloca() {scop.scratchpad} : memref<1xf64>
    ...
    affine.if #set0()[%3, %2] {
        ...
        affine.for %arg6 = #map2(%arg5) to #map3()[%3] {
          affine.for %arg7 = #map4(%arg5) to min #map5(%arg5, %arg6)[%3] {
            affine.for %arg8 = max #map6(%arg6, %arg7) to min #map7(%arg6)[%3] {
              call @S5(%arg3, %arg7, %arg8) : (memref<?x2600xf64>, index, index) -> ()
            }
          }
        }
      }
      affine.for %arg5 = 0 to %3 {
        ...
        affine.for %arg6 = 0 to %2 {
          call @S1(%1, %arg2, %arg6, %arg5) : (memref<1xf64>, memref<?x2600xf64>, index, index) -> ()
        }
        call @S2(%0, %1) : (memref<1xf64>, memref<1xf64>) -> ()
        affine.for %arg6 = 0 to #map3()[%2] {
          affine.for %arg7 = #map4(%arg6) to min #map7(%arg6)[%2] {
            call @S4(%arg4, %arg7, %arg5, %0, %arg2) : (memref<?x2600xf64>, index, index, memref<1xf64>, memref<?x2600xf64>) -> ()
          }
        }
        affine.if #set1(%arg5)[%3] {
            ...
            affine.for %arg7 = 0 to #map3()[%2] {
              affine.for %arg8 = #map4(%arg7) to min #map7(%arg7)[%2] {
                affine.for %arg9 = max #map6(%arg6, %arg5) to min #map7(%arg6)[%3] {
                  call @S6(%arg3, %arg5, %arg9, %arg2, %arg8, %arg4) : (memref<?x2600xf64>, index, index, memref<?x2600xf64>, index, memref<?x2600xf64>) -> ()
                }
              }
            }
            affine.for %arg7 = 0 to #map3()[%2] {
              affine.for %arg8 = #map4(%arg7) to min #map7(%arg7)[%2] {
                affine.for %arg9 = max #map6(%arg6, %arg5) to min #map7(%arg6)[%3] {
                  call @S7(%arg2, %arg8, %arg9, %arg3, %arg5, %arg4) : (memref<?x2600xf64>, index, index, memref<?x2600xf64>, index, memref<?x2600xf64>) -> ()
                }
              }
            }
          }
